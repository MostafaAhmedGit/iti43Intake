###########################################################################
## Makefile generated for Simulink model 'CounterUp'. 
## 
## Makefile     : CounterUp.mk
## Generated on : Mon Dec 26 11:53:33 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CounterUp.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = CounterUp_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = CounterUp_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CounterUp.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/CounterUp_grt_rtw -I$(START_DIR) -IC:/Users/LEGION/Desktop -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=CounterUp -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/CounterUp_grt_rtw/CounterUp.c $(START_DIR)/CounterUp_grt_rtw/CounterUp_data.c $(START_DIR)/CounterUp_grt_rtw/rtGetInf.c $(START_DIR)/CounterUp_grt_rtw/rtGetNaN.c $(START_DIR)/CounterUp_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = CounterUp.obj CounterUp_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/CounterUp_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
