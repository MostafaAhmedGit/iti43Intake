###########################################################################
## Makefile generated for Simulink model 'COUNTERdown'. 
## 
## Makefile     : COUNTERdown.mk
## Generated on : Mon Dec 26 11:35:56 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/COUNTERdown.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/ITI/Matlab/MBD
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = COUNTERdown_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = COUNTERdown_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/COUNTERdown.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/COUNTERdown_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=COUNTERdown -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/COUNTERdown_grt_rtw/COUNTERdown.c $(START_DIR)/COUNTERdown_grt_rtw/COUNTERdown_data.c $(START_DIR)/COUNTERdown_grt_rtw/rtGetInf.c $(START_DIR)/COUNTERdown_grt_rtw/rtGetNaN.c $(START_DIR)/COUNTERdown_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = COUNTERdown.obj COUNTERdown_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/COUNTERdown_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
