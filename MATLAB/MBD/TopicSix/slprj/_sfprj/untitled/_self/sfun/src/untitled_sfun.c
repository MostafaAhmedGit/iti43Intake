  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(406096408U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1054119519U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(86059285U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3737655738U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2345318868U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3985974996U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2896560277U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(630613612U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "5BCLFy177o4hOtZjKMknfB") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "sbXnN8lSKThrEzPuZS6q9EG") == 0) {
